...
INSERT INTO knowledge_nodes (id, org_id, hierarchy_level_id, type, title, content, importance, status, department, zone, source, created_by) VALUES
('N-G01', 'supra', 'HL-03', 'CONSTRAINT', 'Warfarin-NSAID Interaction',
 'CRITICAL: Never prescribe NSAIDs to patients on Warfarin. Risk of life-threatening GI bleed. Alternative: Paracetamol.',
 0.98, 'ACTIVE', NULL, 2, 'SEED', 'U-SHARMA'),
('N-G02', 'supra', 'HL-03', 'CONSTRAINT', 'Penicillin Allergy Cross-Reactivity',
 'Patients with documented penicillin allergy: use azithromycin as first-line alternative. Always check allergy band.',
 0.95, 'ACTIVE', NULL, 2, 'SEED', 'U-SHARMA'),
('N-G03', 'supra', 'HL-03', 'ANTI_PATTERN', 'Verbal Orders Without Documentation',
 'NEVER accept verbal orders for medication changes without written confirmation within 1 hour.',
 0.90, 'ACTIVE', NULL, 2, 'SEED', 'U-SHARMA'),
('N-O01', 'supra', 'HL-05-ORTHO', 'DECISION', 'Paracetamol First-Line Post-TKR',
 'Supra Ortho uses Paracetamol 650mg QDS as first-line post-TKR pain management. Escalation: Tramadol 50mg if VAS > 6.',
 0.88, 'ACTIVE', 'ortho', 1, 'SEED', 'U-VIKRAM'),
('N-O02', 'supra', 'HL-05-ORTHO', 'CONSTRAINT', 'DVT Prophylaxis Protocol',
 'ALL ortho surgical patients: Enoxaparin 40mg SC daily starting 12 hours post-op.',
...
('N-046', 'supra', 'HL-12-RAMAIAH', 'FACT', 'Ramaiah: Medication Profile',
 'Ramaiah 68M. Warfarin 5mg daily (AF). Clopidogrel 75mg daily (post-stent). Paracetamol 650mg QDS (knee pain). Atorvastatin 40mg HS.',
 0.85, 'ACTIVE', 'ortho', 1, 'SEED', 'U-VIKRAM'),
('N-047', 'supra', 'HL-12-RAMAIAH', 'DECISION', 'Ramaiah: Pain Management Strategy',
 'Current strategy: Paracetamol 650mg QDS + topical Diclofenac gel. If insufficient: consider intra-articular injection. NO oral NSAIDs.',
...
('N-060', 'supra', 'HL-12-AADHYA', 'CONSTRAINT', 'Aadhya: Penicillin Allergy',
 'Aadhya 3.5F. Documented penicillin allergy: anaphylaxis at 18 months. Azithromycin as alternative. NEVER prescribe penicillin-class antibiotics.',
 0.99, 'ACTIVE', 'paediatrics', 1, 'SEED', 'U-SHARMA'),
('N-061', 'supra', 'HL-12-AADHYA', 'FACT', 'Aadhya: Infection History',
 'Aadhya: 4 ear infections in 12 months. Mother frequently asks for amoxicillin. Always refuse with explanation.',
 0.75, 'ACTIVE', 'paediatrics', 1, 'CAPTURE', 'U-SHARMA'),
('N-M01', 'supra', 'HL-05-MED', 'DECISION', 'Sepsis Protocol v3',
 'Sepsis Bundle v3: cultures before antibiotics, lactate within 1 hour, 30mL/kg crystalloid, vasopressors if MAP <65.',
 0.95, 'ACTIVE', 'medicine', 1, 'SEED', 'U-SHARMA'),
('N-M02', 'supra', 'HL-05-MED', 'CONSTRAINT', 'Diabetic Fasting Protocol',
 'Fasting diabetic patients: adjust insulin timing not dose. Skip Glimepiride on fast days. BG q4h.',
 0.90, 'ACTIVE', 'medicine', 1, 'SEED', 'U-SHARMA'),
('N-D01', 'supra', 'HL-05-ORTHO', 'FACT', 'What is Osteoarthritis',
 'Osteoarthritis is a degenerative joint disease characterized by cartilage breakdown, pain, and stiffness.',
 0.35, 'ACTIVE', 'ortho', 1, 'SEED', 'U-VIKRAM'),
('N-D02', 'supra', 'HL-05-MED', 'FACT', 'Tramadol Mechanism of Action',
 'Tramadol is a centrally acting synthetic opioid analgesic. Binds to mu-opioid receptors.',
 0.30, 'ACTIVE', 'medicine', 1, 'SEED', 'U-SHARMA'),
('N-070', 'supra', 'HL-08-ORTHO', 'DECISION', 'Post-Surgical Pain Escalation Ladder',
 'Pain escalation: Step 1 Paracetamol 650mg QDS → Step 2 Tramadol 50mg TDS → Step 3 Morphine 5mg PRN.',
 0.80, 'ACTIVE', 'ortho', 1, 'SEED', 'U-VIKRAM'),
('N-071', 'supra', 'HL-05-ORTHO', 'FACT', 'Supra Ortho Implant Preferences',
 'Zimmer Biomet preferred for TKR. Smith & Nephew for revision cases.',
